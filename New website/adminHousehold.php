...
<div class="container-fluid">
  <div class="row content">
    <div class="col-sm-3" style = "background-color :#E0E0E0 ">
	  ...
	  <script type="text/javascript">
		...
		<!-- this is the form for the search panel -->
		 <form name = "mrpQuery" method = "post" target = "_self" action = "adminHousehold.php">
    ...
    <div class="col-sm-9">
     <h2 class = "text-danger"style="text-align:center">Household</h2>
    <?php
    require('config.php');
		...
		$productName_search = $_REQUEST['product_name'];
          ...
          $sql = "SELECT * FROM householdDetails where (MRP >= $rangeLower and MRP <= $rangeUpper) and (costPrice >= $costLower 
